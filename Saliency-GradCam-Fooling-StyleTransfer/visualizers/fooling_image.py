    ...
    def make_fooling_image(self, X, target_y, model):
        ...
        for it in range(max_iter):
            ...
            if pred_y != target_y:
                ...
                normalized_grad =  X_fooling_var.grad / torch.norm(X_fooling_var.grad)

                # inplace add the gradient to the input image
                X_fooling_var.data.add_(learning_rate * normalized_grad)
            ##############################################################################
            #                             END OF YOUR CODE                               #
            ##############################################################################
