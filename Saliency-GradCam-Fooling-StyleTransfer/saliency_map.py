...
# Example with captum
# Computing and visualizing Integrated Gradient (NOTE: Integrated gradients and saliency map are not the same thing, we are providing IG as an example.)
...
attr_sal = compute_attributions(saliency, X_tensor, target=y_tensor)
visualize_attr_maps('visualization/saliency_map_captum.png', X, y, class_names, [attr_sal], ['Saliency'])
##############################################################################
#                             END OF YOUR CODE                               #
##############################################################################
