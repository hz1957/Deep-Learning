...
def train(epoch, data_loader, model, optimizer, criterion):
    ...
    for idx, (data, target) in enumerate(data_loader):
        ...
        # 3. Compute gradients and update model parameters     
        optimizer.zero_grad() # Initialize the gradients to zeros
        loss.backward() # The computed gradients are stored in the grad attributes of the model's parameters.
        optimizer.step() # The optimizer uses these stored gradients to update the model's parameters.
        #############################################################################
        #                              END OF YOUR CODE                             #
        #############################################################################
