...
def run():
    ...
    if args.debug:
        ...
        print("Final Accuracy on Train Data: {accuracy:.4f}".format(accuracy=best_acc_train_acc))
        print("Final Accuracy on Validation Data: {accuracy:.4f}".format(accuracy=best_acc))
